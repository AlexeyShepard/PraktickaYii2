<a href="/frontend/web/main/contract?id=<?= $_GET['id']?>" title="Вернуться обратно к списку договоров" data-pjax="0">
...
?>
    ...
    <?php //$form->field($model, 'Total_cost')->label('Итоговая сумма')->hint("Не более 200 символов") ?>
